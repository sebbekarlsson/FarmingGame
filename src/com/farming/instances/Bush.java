...
Random random = new Random();
	...
	public Bush(int x, int y ) {
		super(x, y);
		this.setSprite("images/plants/bush.png");
	...
	public void growFruits(){
		for(int i = 0; i < 10; i ++){
			...
			TreeFruit f;
			try {
				f = (TreeFruit) product.getClass().getDeclaredConstructor(int.class,int.class).newInstance(x+random.nextInt(32-16)+8,y+random.nextInt(32-16)+4);
